...
include("includes/connection.php");
	...
	if(isset($_POST['sign_up'])){
		...
		$check_username_query = "select l_name from users where user_email='$email'";
		...
		$rand = rand(1, 3); //Random number between 1 and 3
			...
			$insert = "insert into users (f_name,l_name,user_pass,user_email,user_gender,user_birthday,user_cover,user_image,posts)
		values('$first_name','$last_name','$pass','$email','$gender','$birthday','default_cover.jpg','$profile_pic','$posts')";
