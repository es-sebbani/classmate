				...
				<div id="loaded_msg">
					<p>
						<?php
							...
							{
								echo "<div class='message' id='blue' data-toggle='tooltip' title=".$date.">".$msg_body."</div><br><br><br>";
						}else if($user_from == $user_to_msg && $user_to == $user_from_msg)
						{
							echo" <div class='message' id='green' data-toggle='tooltip' title='".$date."'>".$msg_body."
							</div></div><br><br><br>";
					}
						?>
					</p>
	 ...
	 <div class='row'>
	 	...
	 	<center>
	 		<div style='background-color: #e6e6e6;' class='col-sm-9'>
	 			...
	 			<img  class='img-circle' src='users/sunflower.jpg' width='150px' height='150px'><br><br>
	 			<ul class='list-group'>
	 				<li class='list-group-item' title='Username'><strong>".$l_name."".$f_name."</strong></li>
			...
			<center>
				<div style='background-color: #e6e6e6;' class='col-sm-9'>
					...
					<ul class='liste-group'>
						<li class='liste-group-item' title='username'><strong>$f_name $l_name</strong></li>
						<li class='liste-group-item' title='User status'><strong style='color: grey;'>$describe_user</strong></li>
						<li class='liste-group-item' title='Gender'>$gender</li>
						<li class='liste-group-item' title='User Registration Date'>$register_date</li>
					</ul>
				</div>
				<div class='col-sm-1'>
				</div>
