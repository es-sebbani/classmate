...
<div class="row">
	...
	<div class="col-sm-8">
		<?php
			echo"
			<div>
				<div><img id='cover-img' class='img-rounded' src='cover/default_cover.jpg' alt='cover'></div>
			...
			<div id='profile-img'>
				<img style='position:relative;top:-70px;right:-30px;' src='users/sunflower.jpg' alt='Profile' class='img-circle' width='100px' height='100px'>
				<form action='profile.php?u_id='$user_id' method='post' enctype='multipart/form-data'>
		...
		<?php
			...
			if(isset($_POST['submit'])){
				...
				if($u_cover==''){
					...
					$ext=$cover+$random_number;
					move_uploaded_file($image_tmp, "cover/".$u_cover.".".$random_number.".png");
	...
	<?php
		if(isset($_POST['update'])){
			    $_FILES['u_image']['name']='default_cover.jpg';
			...
			//now we will display the posts 
			 ...
			 if($content== "NO" && strlen($upload_image) >= 1){
				...
				<div id='own_posts'>
						<div class='row'>
							<div class='col-sm-2'>
								<p><img src='users/".$user_image.".jpg' class='img-circle' width='100px' height='100px'></p>
							</div>
