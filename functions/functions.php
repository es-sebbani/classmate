...
function single_post(){
		...
		";
			...
			if(isset($_POST['replay'])){
				...
				if($comment == ""){
					...
					$insert = "insert into copmments (post_id,user_id,comment,comment_author,date) values('$post_id,'$user_id','$comment','$user_com_name',NOW())";
					$run = mysqli_query($con ,$insert);
	...
	function search_user(){
		...
		if(isset($_GET['search_user_btn'])){
			$search_query = htmlentities($_GET['search_user_btn']);
